package io.multiagent.activity.settings.entity;
...
public class ConsultantProfileEntity {
    ...
    private io.multiagent.activity.model.VehicleType vehicleType = io.multiagent.activity.model.VehicleType.CAR;
