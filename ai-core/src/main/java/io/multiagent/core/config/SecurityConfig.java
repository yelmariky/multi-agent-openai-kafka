    ...
    SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                // SSE streams — EventSource ne supporte pas les headers custom, auth via query param ?token=
                .requestMatchers("/admin/notifications/stream", "/consultant/notifications/stream").permitAll()
                // Autres endpoints notifications admin = admin ou manager
