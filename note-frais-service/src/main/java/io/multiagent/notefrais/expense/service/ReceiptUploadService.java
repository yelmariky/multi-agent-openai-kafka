...
public class ReceiptUploadService {
        ...
        try {
            ...
            if (expense != null) {
                try {
                    ...
                    log.warn("Impossible de générer l'id incrémental (upload) : {}", e.getMessage());
                }
                ...
                expenseRepo.indexExpense(id, expense, "receipt", dup.isBinaryDuplicate() || dup.isTextDuplicate(), binaryHash);
            }
    ...
    private ExpenseItem parseExpense(String json) {
        ...
        try {
            ...
            log.warn("Impossible de parser la dépense extraite: {}", e.getMessage());
            return null;
        }
    }
