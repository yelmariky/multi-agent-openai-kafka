...
public class CraController {
    ...
    public ResponseEntity<Object> absences(
            ...
            @RequestParam(required = false) String consultant) {
        try {
            List<AbsencePeriod> absences = craService.getKmAbsences(company, month, consultant);
