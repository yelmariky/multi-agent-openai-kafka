...
public class ChatbotService {
    ...
    static final String FALLBACK_REPLY =
            ...
            + "demo@ia-insightservices.fr ou 06 69 00 91 08.";
    ...
    private static final String DEFAULT_SYSTEM_PROMPT = """
            ...
            CRA mensuel temps réel, congés CP/RTT, assistant IA sur les données de l'entreprise, \
            dashboard direction (CA facturable, marge nette, taux d'activité, pipeline CRA, alertes).
