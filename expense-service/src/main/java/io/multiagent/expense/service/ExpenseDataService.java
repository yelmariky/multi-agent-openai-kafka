...
import io.multiagent.expense.cra.entity.CraEntity;
import io.multiagent.expense.cra.repository.CraJpaRepository;
...
import io.multiagent.expense.expense.entity.ExpenseEntity;
import io.multiagent.expense.expense.repository.ExpenseJpaRepository;
import io.multiagent.expense.infrastructure.tenant.TenantContext;
import io.multiagent.expense.model.ConsultantProfile;
import io.multiagent.expense.model.CraDayEntry;
import io.multiagent.expense.model.CraRequest;
import io.multiagent.expense.model.ExpenseItem;
import io.multiagent.expense.model.SellerProfile;
import io.multiagent.expense.settings.entity.ConsultantProfileEntity;
import io.multiagent.expense.settings.entity.SellerProfileEntity;
import io.multiagent.expense.organization.repository.MissionRepository;
import io.multiagent.expense.settings.repository.ConsultantProfileJpaRepository;
import io.multiagent.expense.settings.repository.SellerProfileJpaRepository;
...
public class ExpenseDataService {
    ...
    @org.springframework.beans.factory.annotation.Value("${expense.rag.min-similarity:0.70}")
